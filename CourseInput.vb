...
Public Class CourseInput
    ...
    'For Go back button
    Private boolIsFromCourseInput As Boolean
    ...
    Private Sub CourseInput_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnPreviousCourse_Click(sender As Object, e As EventArgs) Handles btnPreviousCourse.Click
        ...
        'Getting a row from the datagrid
        Dim specificRow As DataGridViewRow
        Dim intPreviousIndex As Integer = (intCoursesRowCounter - 1)
    ...
    Private Sub btnNextCourse_Click(sender As Object, e As EventArgs) Handles btnNextCourse.Click
    ...
    Private Sub btnBack_Click(sender As Object, e As EventArgs) Handles btnBack.Click
        ...
        If boolIsFromCourseInput = True Then
            gbShowCgpa.Visible = False
            gbGPA.Visible = False
            gbHomePage.Visible = False
        Else
            gbShowCgpa.Visible = False
            gbHomePage.Visible = False
            gbGPA.Visible = True
